...
const SystemMonitoring: React.FC = () => {
  ...
  const loadSystemLogs = async () => {
    try {
      const { logs } = await adminService.getSystemLogs(logFilters as any);
      setSystemLogs(logs);
    } catch (error) {
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="w-full bg-secondary-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${systemHealth.memoryUsage > 80 ? 'bg-red-600' :
                    ...
                    <div>
                      ...
                      <div className="w-full bg-secondary-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${systemHealth.diskUsage > 80 ? 'bg-red-600' :
                    ...
                    <div>
                      ...
                      <div className="w-full bg-secondary-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${systemHealth.errorRate > 5 ? 'bg-red-600' :
